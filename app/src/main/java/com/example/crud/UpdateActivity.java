    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.execSQL("update perpustakaan set editnama='" +
                        editnama.getText().toString() +"', editjudulbuku= '" +
                        editjudulbuku.getText().toString() + "', namapengarang= '" +
                        namapengarang.getText().toString() + "', edittahun= '" +
                        edittahun.getText().toString() + "',editjenisbuku= '" +
                        editjenisbuku.getText().toString() + "', editpinjam= '" +
                        editpinjam.getText().toString() + "' where editnama = '" +
                        getIntent().getStringExtra("editnama")+"'");
                Toast.makeText(UpdateActivity.this, "Buku Berhasil Di Update", Toast.LENGTH_SHORT).show();
